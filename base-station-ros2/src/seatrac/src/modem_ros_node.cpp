...
public:
  ...
  ModemRosNode()
    ...
    /**
     * @param base_station_modem_id
     *
     * The id of the base station acoustic modem to identify it
     * on the Cougars UV network.
     */
    this->declare_parameter("base_station_modem_id", 15);
    ...
    BID_E beaconId = (BID_E)(this->get_parameter("base_station_modem_id").as_int());
